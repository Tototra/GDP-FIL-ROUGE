...
class LREGraph:
    ...
    def add_publication(self, pid, author, coauthors, title, topic, venue, year, url="", max_coauthors=10):
        ...
        safe_venue = str(venue[1]).replace(" ", "_")[:50]
